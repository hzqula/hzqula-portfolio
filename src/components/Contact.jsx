...
const Contact = ({ id }) => {
  return (
    <section
      id={id}
      className="flex items-center relative flex-col lg:justify-center lg:w-full h-dvh lg:h-[calc(100vh_-_5rem)] mx-auto bg-primary gap-16 lg:gap-0 snap-start snap-always"
    >
